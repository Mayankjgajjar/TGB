        ...
        <div className={styles.grid}>
          ...
          <div>
            ...
            <ul className={styles.linksList}>
              ...
              <li className={styles.linkItem} style={{ marginTop: 'var(--space-8)' }}>
                <a href="tel:+917940099099" style={{ color: 'var(--color-off-white)', fontWeight: 500 }}>
                  +91 79 400 99 099
                </a>
              </li>
              <li className={styles.linkItem}>
                <a
                  href="https://wa.me/919909909909"
                  target="_blank"
