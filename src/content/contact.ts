...
export const contactContent = {
  header: {
    ...
    subtitle: "We collaborate with architects, builders, and project developers globally. Address your specifications directly to our office in Gujarat."
  },
  offices: [
    {
