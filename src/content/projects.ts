...
export const projectsContent = {
  header: {
    ...
    subtitle:
      'A catalog of engineered installations fabricated for commercial facades, towers, and civic plazas.',
  },
  items: [
    {
      ...
      materials: ['Weatherproof ACP Cladding', 'SS 316 Letters', 'LED Backlit Systems'],
      dimensions: {
        height: '3.5m',
        width: '12.0m',
      },
