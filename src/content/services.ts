...
const standardProcess: ServiceProcess[] = [
  {
    ...
    description:
      'Technical evaluation of the site architecture, viewing angles, and structural requirements.',
  },
  {
    step: '02',
    title: 'Engineering & Design',
    description:
      'Creation of precision blueprints, material selection, and 3D mockups for approval.',
  },
  {
    step: '03',
    title: 'Manufacturing',
    description:
      'In-house fabrication using CNC routing, laser cutting, and premium architectural materials.',
  },
  {
    step: '04',
    title: 'Installation',
    description: 'Secure, code-compliant structural mounting by our certified installation teams.',
  },
  {
    step: '05',
    title: 'Support & Maintenance',
    description:
      'Ongoing warranty support and scheduled maintenance to ensure decades of performance.',
  },
];
...
export const servicesData: Record<string, ServiceDetail> = {
  'led-sign-boards': {
    ...
    positioning:
      'Engineered for 24/7 brand visibility. Precision illumination meets architectural permanence.',
    overview: {
      description:
        'Our LED sign boards are designed to deliver uncompromising brightness and perfect light distribution. We utilize high-efficiency LED modules enclosed in weather-sealed housing, ensuring your brand remains impossible to miss even in the harshest conditions.',
      whyItMatters:
        'Visibility is the foundation of physical branding. A dim or failing sign degrades brand trust. Our LED systems guarantee even, intense illumination that commands authority.',
      whoItIsFor:
        'Retailers, corporate headquarters, hospitality groups, and large-scale commercial real estate developments.',
    },
    capabilities: {
    ...
    specifications: {
      ...
      weatherResistance:
        'IP67 rated. Withstands Category 4 hurricane winds and extreme UV exposure.',
    ...
    faqs: [
      {
        ...
        answer: 'We use premium modules rated for 50,000 to 100,000 hours of continuous operation.',
      },
      {
        question: 'Is the lighting uneven or spotty?',
        answer:
          'No. We calculate precise LED placement and use light-diffusing acrylics to guarantee zero hot-spots.',
      },
    ],
    seoMetadata: {
      title: 'Premium LED Sign Boards | TGB Enterprise',
      description:
        'High-impact, architecturally integrated LED sign boards. Precision engineered in Ahmedabad for unmatched 24/7 visibility.',
    },
  },
  'acp-sign-boards': {
    ...
    overview: {
      description:
        'Aluminium Composite Panels (ACP) offer the perfect balance of rigidity, weight, and weather resistance. We CNC-rout ACP to create seamless, flat facades that act as the perfect canvas for 3D letters or routed illumination.',
      whyItMatters:
        'A seamless facade projects stability. ACP allows us to cover large exterior spans with zero warping or oil-canning, ensuring a perfectly flat, premium surface.',
      whoItIsFor:
        'Automotive dealerships, corporate campuses, industrial facilities, and modern retail environments.',
    },
    capabilities: {
      ...
      customization: [
        ...
        'Back-lit Routed Logos',
        'Multi-panel Seamless Joins',
      ],
    },
    specifications: {
    ...
    faqs: [
      {
        question: 'Will the color fade in the sun?',
        answer:
          'We exclusively use PVDF coated exterior-grade ACP, which guarantees color retention for over 10 years even under direct Indian sunlight.',
      },
      {
        question: 'Can ACP be curved?',
        answer:
          'Yes, our engineering team can route and roll ACP to wrap around architectural pillars and curved facades seamlessly.',
      },
    ],
    seoMetadata: {
      title: 'ACP Sign Boards & Facades | TGB Enterprise',
      description:
        'Precision-engineered ACP signage and cladding. Seamless, weatherproof, and architecturally brilliant.',
    },
  },
  'neon-sign-boards': {
    ...
    overview: {
      description:
        'Combining the nostalgic aesthetic of neon with modern, ultra-durable LED silicone flex technology. We craft neon signs that are unbreakable, highly energy-efficient, and capable of rendering complex typography and logos with perfect luminance.',
      whyItMatters:
        "Neon isn't just a sign; it's an architectural lighting feature. It sets the mood, draws foot traffic, and becomes a highly photogenic centerpiece for your interior or exterior.",
      whoItIsFor:
        'Bars, restaurants, boutique hotels, creative agencies, and modern retail concepts.',
    },
    capabilities: {
    ...
    faqs: [
      {
        question: 'Is this traditional glass neon?',
        answer:
          'No, we use premium LED silicone flex. It looks identical to glass neon but uses 80% less power, is unbreakable, and stays cool to the touch.',
      },
      {
        question: 'Can it be installed outdoors?',
        answer:
          'Yes, we can seal the flex and use waterproof power supplies for fully exposed exterior installations.',
      },
    ],
    seoMetadata: {
      title: 'Custom Neon Sign Boards | TGB Enterprise',
      description:
        'Premium LED neon signs for hospitality and retail. Unbreakable, vibrant, and engineered for atmosphere.',
    },
  },
  'acrylic-letters': {
    ...
    positioning:
      'Sharp, clean, and endlessly versatile. The standard for premium corporate identity.',
    overview: {
      description:
        'Acrylic letters offer incredible versatility in depth, color, and illumination. We laser-cut and hand-finish premium cast acrylic to create solid 3D letters, halo-lit logos, and front-illuminated channel letters with razor-sharp edges.',
      whyItMatters:
        'Acrylic provides a perfectly smooth, glossy, or matte finish that looks expensive up close. It allows for perfect diffusion of light, creating an elegant glow rather than harsh glare.',
      whoItIsFor:
        'Corporate offices, luxury retail boutiques, clinics, and interior reception walls.',
    },
    capabilities: {
    ...
    specifications: {
      ...
      maintenance:
        'Low. Susceptible to scratching, clean only with soft microfiber and acrylic cleaners.',
    },
    pricing: {
    ...
    faqs: [
      {
        question: 'Will white acrylic turn yellow over time?',
        answer:
          'Cheap extruded acrylic will yellow. We strictly use premium UV-stabilized cast acrylic that stays pure white for years.',
      },
      {
        question: 'Can you match my exact brand color?',
        answer:
          'Yes, we can apply translucent Avery or 3M vinyl films to match exact Pantone colors perfectly.',
      },
    ],
    seoMetadata: {
      title: '3D Acrylic Letters & Logos | TGB Enterprise',
      description:
        'Precision laser-cut acrylic letters. Front-lit, halo-lit, and solid options for premium corporate branding.',
    },
  },
  'ss-letters': {
    slug: 'ss-letters',
    ...
    overview: {
      description:
        'Stainless Steel (SS) letters are the pinnacle of architectural signage. We utilize 304 and 316-grade steel, precision laser-cut and welded by master craftsmen to create seamless, heavy-duty 3D letters that project absolute authority and luxury.',
      whyItMatters:
        'Nothing mimics the weight and reflection of real metal. SS letters convey a sense of establishment, wealth, and uncompromising quality that plastics cannot achieve.',
      whoItIsFor:
        'Luxury hotels, high-end residential developments, premium jewelers, and government institutions.',
    },
    capabilities: {
    ...
    specifications: {
      ...
      weatherResistance:
        '100% Rust-proof (when 316 grade is used). Indestructible under normal conditions.',
      warranty: '10-Year structural and anti-rust warranty.',
      certifications: 'Material Test Certificates (MTC) provided.',
      maintenance:
        'Requires occasional polishing with SS cleaner to maintain luster and remove fingerprints.',
    },
    pricing: {
    ...
    faqs: [
      {
        question: 'Will the steel rust outdoors?',
        answer:
          'Standard 304 grade is excellent for most outdoor uses. For coastal areas or high-pollution zones, we upgrade to 316 marine-grade steel to guarantee zero rusting.',
      },
      {
        question: 'Can steel letters light up?',
        answer:
          "Steel itself is opaque, but we specialize in 'Halo-lit' designs where LEDs are mounted inside the steel letter, casting a luxurious glow against the wall behind it.",
      },
    ],
    seoMetadata: {
      title: 'Stainless Steel & Titanium Sign Letters | TGB Enterprise',
      description:
        'Luxury stainless steel, mirror, and titanium gold 3D letters. Laser-cut and welded for absolute architectural permanence.',
    },
  },
  'pylon-signs': {
    slug: 'pylon-signs',
    ...
    overview: {
      description:
        'Pylon and monument signs are colossal, freestanding architectural structures designed for maximum visibility from highways and main roads. We engineer the heavy MS steel substructures, pour the concrete foundations, and clad them in premium ACP and LED displays.',
      whyItMatters:
        "A pylon sign is often a customer's first physical touchpoint with a commercial property. It must withstand massive wind loads while maintaining a sleek, premium aesthetic at an immense scale.",
      whoItIsFor:
        'Shopping malls, petrol pumps, massive commercial tech parks, hospitals, and highway retail hubs.',
    },
    capabilities: {
      materials: [
        'Heavy MS ISMB Beams',
      ...
      customization: [
        'Multi-tenant Lightboxes',
        'Integrated LED Video Walls',
    ...
    faqs: [
      {
        question: 'Do you handle the structural engineering?',
        answer:
          'Yes. Every pylon over 15ft undergoes rigorous structural analysis and wind-load calculations by our partnered structural engineers before fabrication begins.',
      },
      {
        question: 'Who handles the foundation work?',
        answer:
          'We offer end-to-end turnkey solutions, including digging, RCC casting, and foundation bolt setting.',
      },
    ],
    seoMetadata: {
      title: 'Architectural Pylon & Monument Signs | TGB Enterprise',
      description:
        'Colossal, structurally engineered pylon signs for malls and commercial parks. Built for safety, scale, and visibility.',
    },
  },
};
