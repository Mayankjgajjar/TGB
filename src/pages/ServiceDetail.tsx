        ...
        <Container>
          <div className={styles.overviewGrid}>
            <div className={styles.overviewBlock}>
              <p className={`${styles.overviewText} prose`}>{service.overview.description}</p>
            ...
            <div className={styles.overviewSidebar}>
              <div>
                <span className={styles.sidebarSectionTitle}>WHY IT MATTERS</span>
                <p className={`${styles.sidebarText} prose`}>{service.overview.whyItMatters}</p>
              </div>

              <div>
                <span className={styles.sidebarSectionTitle}>WHO IT IS FOR</span>
                <p className={`${styles.sidebarText} prose`}>{service.overview.whoItIsFor}</p>
              </div>
            </div>
          </div>
        </Container>
